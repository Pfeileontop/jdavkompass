    ...
    with get_kompass() as conn:
        ...
        cursor.execute("""
            SELECT 
                ...
                e.id AS eb_id, e.vorname AS eb_vorname, e.nachname AS eb_nachname, e.email AS eb_email, e.telefon AS eb_telefon
        ...
        for row in rows:
            ...
            mitglieder_unapproved_daten.append({**row, "erziehungsberechtigte": erziehungsberechtigte})
